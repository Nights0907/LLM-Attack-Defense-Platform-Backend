...
with open('../../data/sap/data/gpt_negative_score.json', mode='r', encoding="utf8") as f:
    negative_samples = json.load(f)

with open('../../data/sap/data/gpt_positive_score.json', mode='r', encoding="utf8") as f:
...
with open('../../data/sap/data/p_api_negative_score.json', mode='r', encoding="utf8") as f:
    negative_samples = json.load(f)

with open('../../data/sap/data/p_api_positive_score.json', mode='r', encoding="utf8") as f:
    positive_samples = json.load(f)
